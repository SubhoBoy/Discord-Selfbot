...
class Google:
    ...
    def parse_google_card(self, node):
        ...
        if time_in is not None:
            try:
                time_place = "".join(
                    time_in.find("span[@class='_HOb _Qeb']").itertext()
                ).strip()
                the_time = "".join(
                    time_in.find("div[@class='_rkc _Peb']").itertext()
                ).strip()
                the_date = "".join(
                    time_in.find("div[@class='_HOb _Qeb']").itertext()
                ).strip()
            except:
                return None
            else:
